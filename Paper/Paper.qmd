...
Among the 14 identified articles, six also employed methods of cluster analysis (in all but one case using latent class or latent profile analysis). In five of the six cases, cluster analysis was conducted in parallel with taxometric analysis [@james2016latent; @munson2008asd; @frazier2023asd; @frazier2007adhd; @deserno2023probing], while in one case it was performed as a secondary analysis [@frazier2010asd]. In all cases, clustering results were interpreted as supporting taxonic conclusions, always converging with those from taxometric analyses, with the exception of @frazier2007adhd, where clustering results were partially inconclusive yet suggested the presence of subgroups, in contrast to the dimensional structure indicated by taxometric analysis. In all but two studies [@frazier2007adhd; @munson2008asd], we identified at least some risk of artificial admixture.
...
The present review suggests that taxometric analysis has been underused in neurodevelopmental research, and that many articles using it present relevant methodological limitations or incomplete reporting of crucial information. This is unfortunate in light of the unique relevance of taxometric analysis for the current debate on the categorical vs dimensional nature of NDDs[@astle2022trandiagnostic; @michelini2024world; @happe2021both]. The underuse of taxometric analysis in this field was expected: of the 183 articles employing taxometric methods on psychopathology identified by @haslam2020metaanalysis only 15 were placed in the "childhood" category (encompassing all types, even conditions such as sleep problems).
